...
int main()
{
	...
	// Points to the border between the partitioned and non-partitioned elements (the first of the non-partitioned)
	auto selected = stable_partition(begin(numbers), end(numbers),
		[](int i) { return i % 2 != 0; }); 
